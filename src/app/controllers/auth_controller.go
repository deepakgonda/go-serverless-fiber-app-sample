...
import (
	...
	"github.com/deepakgonda/go-serverless-test/src/app/models"
	"github.com/deepakgonda/go-serverless-test/src/pkg/logger"
	"github.com/deepakgonda/go-serverless-test/src/pkg/utils"
	"github.com/deepakgonda/go-serverless-test/src/platform/database"
	"github.com/deepakgonda/go-serverless-test/src/platform/database/cache"
...
func UserSignIn(c *fiber.Ctx) error {
	...
	if err != nil {
		// Return status 500 and database connection error.
		logger.Error.Printf("DB Error: %s", err.Error())
		return c.Status(fiber.StatusInternalServerError).JSON(fiber.Map{
			"error": true,
			"msg":   err.Error(),
		})
